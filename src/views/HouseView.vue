<template >
  <div class="min-h-screen md:min-h-md w-full flex lg:justify-start flex-col gap-4 relative overflow-hidden"  >
    ...
    <div class="flex justify-center items-center flex-col sm:flex-row p-4 gap-8 lg:gap-[5rem]">
        ...
        <form autocomplete="off" @submit.prevent="buyHouse" action="" class="bg-[#123456] rounded-[10px] flex flex-col justify-center items-center gap-8 py-8 px-4 max-[360px]:w-[18rem] w-[21rem] sm:h-[35rem] lg:h-[35rem]  xl:w-[20rem] xl:h-[35rem]">
        ...
        <BuyHouseComponent :house="house"></BuyHouseComponent>
...
import BuyHouseComponent from '@/components/BuyHouseComponent.vue';
